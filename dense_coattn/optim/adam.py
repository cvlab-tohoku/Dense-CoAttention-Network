...
class FixedAdam(WrapOptimizer):

	def __init__(self, args, params):
		super(FixedAdam, self).__init__(args, params)
		self._optimizer = Adam(list(params), **self.optimizer_config)
...
class Adam(torch.optim.Optimizer):
	...
	def __init__(self, params, lr=1e-3, betas=(0.9, 0.999), eps=1e-8,
				 weight_decay=0, amsgrad=False, record=True):
		defaults = dict(lr=lr, betas=betas, eps=eps,
						weight_decay=weight_decay, amsgrad=amsgrad, record=record)
